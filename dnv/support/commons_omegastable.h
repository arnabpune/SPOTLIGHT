...
namespace quickgeom
{
	...
	*/
	...
	/*static std::vector<Eigen::Vector3d> getArcPositions(const Eigen::Vector3d& fixed,const Eigen::Vector3d& def,double length,double angle,std::vector<double> dihedral,int num=10,int devid=0)
	{
	...
	*/
	...
	public:
		...
		*/
		...
		//Assume this box to have PBC applied to it. Now apply PBC transformations to a (relative) position vector here.
